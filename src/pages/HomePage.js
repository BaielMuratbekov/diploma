...
import MainHeaderImg from "../assets/Mainheader.jpg";
export const HomePage = () => {
  return (
    <div className="Home-page">
      ...
      <PlayersHeader />
      <>
        <Header title="Welcome to our football store!" image={HeaderImg}>
          <p>
            ...
            Canadian football); Australian rules football; rugby union and rugby
            league; and Gaelic football.[1] These various forms of football
            share to varying extent common origins and are known as football
            codes.
          </p>
        </Header>
      </>
      <MainHeader title="Spring looks" image={MainHeaderImg}>
        <p>Upgrate your collection.</p>
      </MainHeader>
